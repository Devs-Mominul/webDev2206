								...
								<ul class="contacts">
									<li class="active">
										<div class="d-flex bd-highlight">
											...
											<div class="ml-auto">
												<a href="javascript:void(0)" class="mr-1 btn btn-primary btn-xs sharp"><i class="fa fa-pencil"></i></a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                      ...
                                      <img src="{{ asset('upload/profile/' . Auth::user()->photo) }}" width="20px" alt=""/>
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('backend.order') }}">Order</a></li>
                            <li><a href="{{ route('role.manager') }}">role</a></li>
