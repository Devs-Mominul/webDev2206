            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    <form action="{{ route('cart.update') }}" method="POST">
                                ...
                                <tbody>
                                    ...
                                    <tr class="wishlist-item">
                                        <td class="product-item-wish">
                                            ...
                                            <div class="product">
                                                <ul>
                                                    <li class="first-cart">{{ $cart->rel_to_product->product_name }} Coat</li>
                                                    <li>
                                        ...
                                        <td class="td-quantity cartabc">
                                            <div class="quantity ">
                                                <input class="text-value quant" name="quantity[{{ $cart->id}}]" type="text" value="{{ $cart->quantity }}">
                        ...
                        <button type="submit" class="mt-3 theme-btn-s2" ><i class="fi flaticon-refresh"></i> Update Cart</button>
                  ...
                  <form action="{{ route('carts') }}" method="get">
                    @csrf
                        ...
                        <div class="apply-area mb-3">
                            <input type="text" name="coupon_name" class="form-control" placeholder="Enter your coupon">
