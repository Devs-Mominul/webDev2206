                        ...
                        <div class="col-lg-4 col-12">
                            <div class="middle-right">
                                <ul>
                                    ...
                                    @auth('customer')
                                    <li><a href="{{ route('customer.profile') }}"><i class="fi flaticon-user-profile"></i><span>{{ Auth::guard('customer')->user()->fname }}</span></a></li>
                                    ...
                                    <li>
                                        <div class="mini-cart">
                                            ...
                                            <div class="mini-cart-content">
                                                <button class="mini-cart-close"><i class="ti-close"></i></button>
                                                <div class="mini-cart-items">
                                                   @foreach (App\Models\Cart::where('customer_id',Auth::guard('customer')->id())->get() as $cart_item )
                                                   @php
                                                   $sub=0;
                                                   ...
                                                   <div class="clearfix mini-cart-item">
                                                    <div class="mini-cart-item-image">
                                                        <a href="product.html"><img src="{{ asset('upload/preview/') }}/{{ $cart_item->rel_to_product->preview }}" alt></a>
                                                    </div>
                                                    <div class="mini-cart-item-des">
                                                        <a href="product.html">{{ $cart_item->rel_to_product->product_name }}</a>
                                                        <span class="mini-cart-item-price">${{ $cart_item->rel_to_product->after_discount }} x {{ $cart_item->quantity }}</span>
                                                        <span class="mini-cart-item-quantity"><a href="#"><i
                                                                    class="ti-close"></i></a></span>
                                                    </div>
                                                </div>
                                                @php
                                                $sub+= $cart_item->rel_to_product->after_discount*$cart_item->quantity;
                                                ...
                                                <div class="clearfix mini-cart-action">
                                                    <span class="mini-checkout-price">Subtotal:
                                                        ...
                                                        @endif</span></span>
                                                    <div class="mini-btn">
                                                        <a href="{{ route('carts') }}" class="view-cart-btn">View Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
